...
def convergence_study():
    ...
    plt.plot(n_values, mid_point_values, 'o-')
    plt.title("Зависимость решения в средней точке от числа узлов сетки", fontsize=14)
    plt.xlabel("Число узлов сетки N", fontsize=12)
    plt.ylabel("Значение в средней точке", fontsize=12)
    plt.grid(True)
    plt.show()
